  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved home as @home" do
        ...
        post :create, {:home => { "name" => "invalid value" }}, valid_session
        assigns(:home).should be_a_new(Home)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested home" do
        ...
        Home.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => home.to_param, :home => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the home as @home" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Home.any_instance.stub(:save).and_return(false)
        put :update, {:id => home.to_param, :home => { "name" => "invalid value" }}, valid_session
        assigns(:home).should eq(home)
      end
